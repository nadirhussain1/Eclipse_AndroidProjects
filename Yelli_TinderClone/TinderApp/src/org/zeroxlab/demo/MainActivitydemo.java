...
public class MainActivitydemo extends FragmentActivity implements AnimationLayout.Listener 
{
...
//        mList.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_multiple_choice,mStrings));
     	 ...
     	 if(Ultilities.isNetworkAvailable(this))
		 {
			   ...
			   if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER))
			   {
				   mMarkerPoints = new ArrayList<LatLng>();
		            ...
		            newLocationFinder.getLocation(MainActivitydemo.this, mLocationResult);	
...
//					});
			  ...
			  Ultilities mUltilities=new Ultilities();
			    ...
			    mUltilities.displayMessageAndExit(this, getResources().getString(R.string.internetconnectionerrortitle), getResources().getString(R.string.internetconnectionerrormessage));
			  }
...
//			downloadTask.execute(url);
    ...
    private void showGPSDisabledAlertToUser(){
		...
		alertDialogBuilder.setMessage(getResources().getString(R.string.gpsenablemessage))
		.setCancelable(false)
