...
public void setLastMsgTime(String key,String time){
	editor.putString(key+"LastTime", time);
	editor.commit();
}
public String getLastMsgTime(String key){
	return pref.getString(key+"LastTime", "");
}
...
{
	return pref.getString(USERPREFSEX, null);
}
...
public void setUserEducation(String education){
	editor.putString("USER_EDU", education);
	editor.commit();	
}
...
public String getUserEducation(){
	return pref.getString("USER_EDU", "");
}
public String getUserWork(){
	return pref.getString("USER_WORK", "");
}
...
editor.clear();
editor.commit();
/* Log.i(TAG, "Usersuccessfully logout..........");
