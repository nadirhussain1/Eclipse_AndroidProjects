...
public class AlertDialogManager {
	...
	public static void errorMessage(Context context, String title,String message)
	{
		...
		builder.setPositiveButton(context.getResources().getString(R.string.okbuttontext),
	...
	public static void internetConnetionErrorAlertDialog(final Activity activity)
	{
		...
		builder.setNegativeButton(activity.getResources().getString(R.string.okbuttontext),
				new DialogInterface.OnClickListener() 
		{
			@Override
			public void onClick(DialogInterface dialog, int which) 
