...
public class MainLayout extends LinearLayout
{
			...
			int bottom) 
	{
		if (changed) 
		{
			...
			LayoutParams LeftmenuLayoutParams = (LayoutParams) menuRigth.getLayoutParams();
	...
	public void toggleMenu() 
	{
		...
		case HIDDEN:
			...
			menuScroller.startScroll(0, 0, menu.getLayoutParams().width-50, 0,	SLIDING_DURATION);
			break;
		case SHOWN:
	...
	public void toggleMenuRight() 
	{
		...
		if (currentMenuStateleft == MenuStateRight.HIDING|| currentMenuStateleft == MenuStateRight.SHOWING)
			return;
		...
		case HIDDEN:
			...
			menuScroller.startScroll(0, 0, -menuRigth.getLayoutParams().width+50, 0,	SLIDING_DURATION);
			break;
		case SHOWN:
	...
	public boolean onContentTouch(View v, MotionEvent event) 
	{
		...
		if (currentMenuState == MenuState.HIDING|| currentMenuState == MenuState.SHOWING)
			return false;
		else if (currentMenuStateleft == MenuStateRight.HIDING|| currentMenuStateleft == MenuStateRight.SHOWING)
				 return false;
       ...
       logDebug("onContentTouch  curX  "+curX);
		...
		case MotionEvent.ACTION_MOVE:
			...
			logDebug("onContentTouch  ACTION_MOVE contentXOffset  "+contentXOffset);
			...
			{
				logDebug("onContentTouch  ACTION_MOVE mainLayoutWidth  "+mainLayoutWidth);
				logDebug("onContentTouch  ACTION_MOVE menuRightMargin  "+menuRightMargin);
				logDebug("onContentTouch  ACTION_MOVE contentXOffset  "+contentXOffset);
		...
		case MotionEvent.ACTION_UP:
			...
			{
				currentMenuState = MenuState.HIDING;menuScroller.startScroll(contentXOffset, 0, -contentXOffset, 0,	SLIDING_DURATION);
			}
